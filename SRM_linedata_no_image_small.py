				...
				for k in range(n):
					...
					if not np.isnan(f.get_Area()):
						...
						if flag:
							...
							realLineInBoundOfSRM=camera.getIntersectionLineSegmentInBound(p1,p2,boundOfSRM)
							if segments:
...
parser.add_argument('--only_clip', type=int, default=0)
parser.add_argument('--do_generate', type=int, default=1)
parser.add_argument('--DataSetDir', type=str, default="./DataSetSmall/")
parser.add_argument('--FractureDir', type=str, default="./FractureSmall/")
args = parser.parse_args()
print(args)

#define fracture set
MaxX,MaxY,MaxZ=12,12,500
PB_set1=[60, 40,25,'exp',4,1] #0-15
PB_set2=[210, 70, 20,'exp',4,1] #16-31
PB_set3=[300, 60, 15,'exp',4,1] #32-47
PBDict={
	"PBSet1":[PB_set1],
	"PBSet2":[PB_set2],
	"PBSet3":[PB_set3],
